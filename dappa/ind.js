...
*IG = https://www.instagram/tamadooo_*
*OWNER = https://wa.me/6281271684846*

╔═════════════════❍
║⸨*ʙᴇʙᴇʀᴀᴘᴀ ꜰɪᴛᴜʀ ᴍᴀtɪ ᴅᴀʟᴀᴍ ᴛᴀʜᴀᴘ ᴘᴇᴇʙᴀɪᴋᴀɴ!!*⸩
║▬▭▬▭▬▭▬▭▬▭
...
║┣❥ *${prefix}gemboktext* 11 02 2021 Tamado dan Gaada:)
║┣❥ *${prefix}nulis* Nama/Kelas/Isi
║┣❥ *${prefix}lovemake* Tamado
║┣❥ *${prefix}ffbaner* TamadoUhuy
║┣❥ *${prefix}textlight* TamadoGanz
║┣❥ *${prefix}silktext* TamadoTeros
║┣❥ *${prefix}slide* Tamado Ganz Banget
║┣❥ *${prefix}glitchtext* Tamado & Ganz
║┣❥ *${prefix}pornhub* Tamado & Hub
║┣❥ *${prefix}apiteks* TamadoApi
║┣❥ *${prefix}hartatahta* Tamado
║┣❥ *${prefix}galaxtext* TamadoUhuy
║┣❥ *${prefix}makequote* Bikin Quotes
║┣❥ *${prefix}toimg* Reply Sticker Biar Jadi Image
